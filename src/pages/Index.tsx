        ...
        <div className="max-w-2xl mx-auto text-center">
          ...
          <div className="mb-6">
            <div className="flex items-center justify-center">
              ...
              <h1 className="text-4xl md:text-5xl font-serif text-black drop-shadow-md mb-2">
                Iwona & Szymon
              </h1>
              <Heart className="w-8 h-8 text-yellow-600 ml-3 animate-pulse" />
            </div>
            <div className="text-yellow-700 font-serif font-medium text-2xl mt-4 mb-2">
              14 sierpnia 2025
            </div>
            <h2 className="text-xl md:text-2xl font-serif text-black/90 drop-shadow-md">
